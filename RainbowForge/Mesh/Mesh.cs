...
namespace RainbowForge.Mesh
{
	...
	public class Mesh
	{
		...
		private Mesh(MeshHeader meshHeader, MeshObjectContainer container, List<TrianglePointer[]> objects, List<ushort[]> vertMaps, FaceBlockStat[] faceStatBlocks,
		...
		public static Mesh Read(BinaryReader r, MeshHeader header)
		{
			...
			return new Mesh(header, container, objects, vertMaps, faceStatBlocks, unknownFaceData);
		}
