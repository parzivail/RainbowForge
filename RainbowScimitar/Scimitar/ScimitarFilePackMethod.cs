namespace RainbowScimitar.Scimitar
{
	public enum ScimitarFilePackMethod : short
	{
		...
		/// a checksum at the start of each block. Blocks are compressed by Zstd.
		/// </summary>
		BlockZstd = 3,
		...
		/// Indicates the Block strategy for packing file data chunks. The asset
		/// serializes the list of block sizes, and each block is accompanied by
		/// a checksum at the start of each block. Blocks are compressed by Oodle.
		/// </summary>
		BlockOodle = 13,
		...
		/// and blocks are tightly packed with no interruptions. Compression
